...
if __name__ == "__main__":
    ...
    # Guardar histogramas
    fig1 = plot_histogram(counts_c, title="Deutsch-Jozsa — Constante")
    fig1.savefig("capturas/dj_constante_histogram.png", dpi=150)

    fig2 = plot_histogram(counts_b, title="Deutsch-Jozsa — Balanceada")
    fig2.savefig("capturas/dj_balanceada_histogram.png", dpi=150)
